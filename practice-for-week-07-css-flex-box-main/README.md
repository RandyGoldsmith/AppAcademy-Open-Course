...
To complete this practice, you only need to modify **main.css** by adding
...
In **main.css**, you'll find the CSS selector for `.example1`. Your goal is to
...
In **main.css**, you'll find the CSS selector for `.example1`. Please add the
...
In **main.css**, you'll find the CSS selector `.example3` which is already set
...
> (`max-width`) which have already been included in **main.css** (under the
> `.example3` selector).
...
Finally, find the `.example4` and `.sidebar` css selectors in **main.css**.
